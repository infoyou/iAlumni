...
@interface UIButton(ECColorfulButton)
...
@interface UIColor(ECColorfulButton)
...
@interface ECColorfulButton : UIButton {
@private
...
@interface UIGNavigationButton : ECColorfulButton {
@private
	BOOL _leftArrow;
}
...
@interface UIGBadgeButton : ECColorfulButton {
@private
...
@interface ECStandardButton : ECColorfulButton {
