...
- (NSIndexPath*)tableView:(UITableView *)tableView
 willSelectRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  if ([cell isKindOfClass:[BaseUITableViewCell class]]) {
    [((BaseUITableViewCell *)cell) hideLabelShadow];
  } else if ([cell respondsToSelector:@selector(hideLabelShadow)]) {
    [cell performSelector:@selector(hideLabelShadow)];
  }
...
- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView
  ...
  if (_needRefreshHeaderView && scrollView.contentOffset.y <= -(HEADER_TRIGGER_OFFSET) && !_reloading) {
    ...
    [UIUtils animationForScrollViewDidEndDragging:scrollView
