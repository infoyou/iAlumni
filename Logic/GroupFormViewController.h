...
@interface GroupFormViewController : BaseListViewController <ECFilterListDelegate, ECItemUploaderDelegate, ECClickableElementDelegate, TabTapDelegate, ClubManagementDelegate, ECEditorDelegate, UPOMPDelegate> {
  BOOL isFirst;
