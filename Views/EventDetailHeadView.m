...
- (void)initEventBottom {
  ...
  WXWLabel *signUpNumLabel = [[[WXWLabel alloc] initWithFrame:CGRectMake(60.f, 11.f, 60.f, 20.f) textColor:[UIColor whiteColor] shadowColor:[UIColor grayColor]] autorelease];
  ...
  WXWLabel *checkInNumLabel = [[[WXWLabel alloc] initWithFrame:CGRectMake(60.f, 11.f, 60.f, 20.f) textColor:[UIColor whiteColor] shadowColor:[UIColor grayColor]] autorelease];
  ...
  if (0 != [self.event.actionType intValue]) {
    UIImageButton *eventActionBut = [[[UIImageButton alloc]
...
- (void)updateEventPostImg:(UIImage *)image {
  ...
  [_postImgButton setImage:[WXWCommonUtils cutMiddlePartImage:image
                                                        width:POST_W
                                                       height:POST_H]
                  forState:UIControlStateNormal];
}
