...
@interface StartupDiscussionViewController : BaseListViewController  <ECClickableElementDelegate, EventCheckinDelegate, ECItemUploaderDelegate, UIActionSheetDelegate> {
@private
