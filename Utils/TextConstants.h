...
static NSString *const NSCopyTitle = @"copyTitle";
...
static NSString *const NSShareAndInviteTitle = @"shareAndInviteTitle";
static NSString *const NSEnterpriseProposalTitle = @"enterpriseProposalTitle";
...
static NSString *const NSAvatarTitle        = @"avatarTitle";
...
static NSString *const NSHomepageSolganTitle= @"homepageSolganTitle";
static NSString *const NSMottoTitle         = @"mottoTitle";
...
static NSString *const NSTryAgainTitle = @"tryAgainTitle";
...
static NSString *const NSLastestVersionTitle      = @"lastestVersionTitle";
...
static NSString *const NSVideoPlaceholderTitle = @"videoPlaceholderTitle";
...
static NSString *const NSClassMemberTitle = @"classMemberTitle";
